...
corrplot(cor_matrix, method="circle", type = "upper") # only the right part is seen
...
crime <- cut(boston_scaled$crim, breaks = c(0, 25, 50, 75, 100), include.lowest = TRUE, labels = labels)
...
# reduce number of pairs to see plots more clearly
